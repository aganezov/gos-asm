...
from algo.data_structures.assemblies import AssemblyPoint, AssemblyPointInfo
from algo.shared.assembly_point import non_conflicting_evolutionary_scenarios, get_assembly_score
from algo.shared.bg import get_full_irregular_multicolor, get_repeat_info, create_k_break_from_assembly_point
from algo.shared.logging import log_bg_stats
from algo.tasks.asm.shared import suitable_for_assembly_fragment_ends_vertex, get_irregular_edge_by_vertex_color, assembly_is_allowed, \
